...
export function DigitalCTA() {
  ...
  return (
    <section
      ref={sectionRef}
      className="py-20 bg-gradient-to-r from-primary/10 via-background to-primary/10"
    >
      <div className="mx-auto max-w-4xl px-4 lg:px-8 text-center">
        ...
        >
          Let's discuss how our digital marketing expertise can help grow your business
          online. Get a free consultation and custom strategy proposal.
        </p>
        <div
          data-animate
