...
<div className="absolute inset-0 bg-gradient-to-r from-black/20 via-black/10 to-transparent" />   </div>
    ...
    isAnimating ? "opacity-0 scale-105" : "opacity-100"
      ...
      {/* SOCIAL COLUMN */}
      <div className="hidden lg:flex flex-col items-center gap-6 absolute right-6 xl:right-10 top-12">
        {" "}
      ...
      <div className="w-full bg-primary text-black py-3 overflow-hidden">
        <div className="marquee">
          <div className="marquee-inner">
            <span>
              UI/UX Design ✳ Website Design ✳ Mobile Application ✳ Digital
              Marketing ✳ Branding ✳ Outdoor Advertising ✳
            </span>
            <span>
              UI/UX Design ✳ Website Design ✳ Mobile Application ✳ Digital
              Marketing ✳ Branding ✳ Outdoor Advertising ✳
