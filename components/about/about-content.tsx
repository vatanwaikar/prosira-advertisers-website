            ...
            <div className="prose prose-lg prose-invert max-w-none">
              ...
              <div className="space-y-5">
                <p className="text-lg text-muted-foreground leading-relaxed">
                  ...
                  Audience research, media mix optimization, and reach & frequency planning aligned with business objectives.
                </p>
                ...
                <p className="text-lg text-muted-foreground leading-relaxed">
                  ...
                  Efficient buying across digital, TV, print, radio, outdoor, and integrated platforms backed by strong negotiation leverage.
                </p>
                ...
                <p className="text-lg text-muted-foreground leading-relaxed">
                  ...
                  Campaign execution designed to maximize visibility, engagement, and measurable return on advertising investment.
                </p>
              </div>
...
<div data-animate className="f-reveal w-full lg:max-w-none">
          ...
          <div className="space-y-5 mb-10">
            <p className="text-lg text-muted-foreground leading-relaxed">
              ...
              We analyze audience behavior, market trends, and performance data to build precise media strategies.
            </p>
            ...
            <p className="text-lg text-muted-foreground leading-relaxed">
              ...
              We negotiate optimal media placements and continuously optimize campaigns using real-time performance insights.
            </p>
          ...
          <div className="pt-8 border-t border-border">
            ...
            <div className="flex flex-wrap gap-6">
              <Link href="/advertising-services" className="inline-flex items-center gap-2 text-foreground hover:text-primary transition-colors group">
                Advertising Services
                <ArrowRight className="h-4 w-4 group-hover:translate-x-1 transition-transform" />
              </Link>

              <Link href="/digital-marketing" className="inline-flex items-center gap-2 text-foreground hover:text-primary transition-colors group">
                Digital Services
                <ArrowRight className="h-4 w-4 group-hover:translate-x-1 transition-transform" />
              </Link>

              <Link href="/events-expo" className="inline-flex items-center gap-2 text-foreground hover:text-primary transition-colors group">
                Events & Expo
                <ArrowRight className="h-4 w-4 group-hover:translate-x-1 transition-transform" />
              </Link>
            </div>
